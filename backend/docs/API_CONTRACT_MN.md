...
хариултыг дуут болгоно. ӨӨРИЙН лимиттэй (IP тус бүрт ~20/мин, burst 8) — дуут
хариултыг өгүүлбэр тус бүрээр нь дуугаргадаг тул нэг хариулт хэд хэдэн богино
дуудалт үүсгэдэг ба чатын лимит (~6/мин) хариултыг дунд нь тасалдаг байв.
`text` ≤ 800 тэмдэгт, дуу хоолойг сервер сонгоно (дуудагч model
