...
//
//   provider — hero дотор нэвтрэх картыг (LoginPanel → LoginForm) шигтгэнэ,
//              нэвтрэх товчнууд түүн рүү (#login) гүйлгэнэ;
//   client   — карт огт байхгүй, нэвтрэх товчнууд дээд SSO руу шилжүүлнэ.
//
// Сонголтыг ЭНД (server талд) хийж байгаа нь зориуд: `fetchAuthMode()` нь
// server-only тул горимыг browser талд мэдэх аргагүй.
//
