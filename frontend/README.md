...
## Интерфейсийн хэл (динамик)

Хэлний жагсаалт нь **compile-time биш**. Super admin нь `/admin/languages`-аас
хэл нэмж, идэвхжүүлж, орчуулгыг Gemini-ээр бөглөнө — deploy шаардлагагүй.

Хоёр давхаргыг нийлүүлдэг:

| Давхарга | Эх сурвалж | Үүрэг |
|---|---|---|
| Багцлагдсан | `src/lib/i18n.ts` дэх `dict` (mn·en·zh·ru) | **Түлхүүрийн эх сурвалж** + сүлжээгүй/DB унасан үеийн найдвартай суурь |
| Overlay | `GET /api/public/languages/{code}/dictionary` | Super admin-ий удирдсан утга — багцлагдсаныг дарна |

`t()`-ийн эрэмбэ: **overlay → багцлагдсан хэл → монгол → түлхүүрийн нэр.**
Иймд орчуулга дутуу шинэ хэл дээр ч интерфейс хэзээ ч хоосон болохгүй.

- `LangProvider` (`src/lib/lang.tsx`) идэвхтэй хэлүүд + overlay-г татна;
  `useT()` нь `T`, `locale`, `languages`-ыг буцаана.
- Хэлний сонгогч (`UserMenu`) жагсаалтаа API-аас авна; багцлагдаагүй хэлийг
  кодоор нь (`JA`) товчлон үзүүлнэ.
- Landing-ийн текст (`components/landing/copy.ts`) нь багцлагдсан хэвээр —
  шинэ хэл дээр англи руу уналт хийнэ (`landingCopyFor`).
- `i18n.test.ts` нь багцлагдсан дөрвөн хэлийн паритетийг хэвээр албадна.

**"AI-аар суулгах"** нь энэ аппын багцлагдсан монгол dictionary-г backend руу
...
> Backend: platform-core **v0.5.0**+ (migration 49). Дэлгэрэнгүйг
> [platform-core README](https://github.com/gerege-systems/platform-core#интерфейсийн-хэл-v050-оос)-аас.
