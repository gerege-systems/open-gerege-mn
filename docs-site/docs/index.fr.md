...
| **template.gerege.mn** | Application d'exemple — partie utilisatrice de Gerege SSO (se connecte via le SSO) |

Les applications (comme `template.gerege.mn`) se connectent via
